...
import { UserGroupIcon, ShoppingBagIcon, UserIcon, CalendarIcon } from '@heroicons/react/24/outline';
...
const DateRangePicker = ({ fromDate, toDate, onFromDateChange, onToDateChange, onApply, onReset, loading }) => (
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              disabled={userStatsLoading}
              className={`px-3 py-1 text-sm rounded-md ${
                useCustomUserDate ? 'bg-green-50 text-green-600' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
              } disabled:opacity-50 disabled:cursor-not-allowed`}
            >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              disabled={revenueStatsLoading}
              className={`px-3 py-1 text-sm rounded-md ${
                useCustomRevenueDate ? 'bg-green-50 text-green-600' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
              } disabled:opacity-50 disabled:cursor-not-allowed`}
            >
